...
author: 金澤祐輔
lede: "![4119073_s.jpg]こんにちは、コアテクノロジーグループの金澤です。JDK 23のリリースを記念して、バージョン21～23にかけての変更点を紹介する連載が始まります。本記事では１本目としてJDK 21でのアップデート内容を取り上げます。"
---
...
従来のスレッドと仮想スレッドの違い、性能検証についてはJJUG CCC 2024 Springの資料が分かりやすくまとめられていましたので参考までにご参照ください。
