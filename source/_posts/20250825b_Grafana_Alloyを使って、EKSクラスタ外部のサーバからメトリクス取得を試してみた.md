...
- **Disk Space Used Basic**: ディスクごとの使用率(%)を確認できます
- **Network Traffic Basic**

ネットワークインターフェースごとの送受信トラフィック(MB/s)を表示し、通信量の急増や異常を検知できます。
...
アラートの通知先として、Slackやメール等、様々なツールを指定できるため、システムの異常を迅速に検知する体制を構築することができます。
