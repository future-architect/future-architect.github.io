...
<img src="/images/20250512b/rag.png" alt="" width="567" height="332">
...
1. **Azure AI Searchが非Azureサービスとの連携に弱い**
   ...
   <img src="/images/20250512b/azure_ai_search_problem.avif" alt="" width="653" height="393" loading="lazy">
...
<img src="/images/20250512b/image_2.png" alt="" width="1200" height="753" loading="lazy">
...
2. **Azure Purviewでコレクションを作成**
   ...
   <img src="/images/20250512b/image_3.png" alt="" width="1200" height="573" loading="lazy">

3. **Azure Data FactoryとAzure Purviewの接続**
   Azure Purviewの「管理」画面から「系列接続」を選び、Azure Data Factoryの項目で設定します。
   <img src="/images/20250512b/image_4.png" alt="" width="1068" height="388" loading="lazy">
...
4. **ストレージアカウントとAzure Purviewの接続**
   ...
   <img src="/images/20250512b/image_5.png" alt="" width="1200" height="633" loading="lazy">

### Azure Data Factoryによるデータソースの登録

以下の手順で登録します。

<img src="/images/20250512b/image_6.png" alt="" width="1200" height="851" loading="lazy">
...
<img src="/images/20250512b/image_7.png" alt="" width="1105" height="889" loading="lazy">

<img src="/images/20250512b/image_8.png" alt="" width="995" height="632" loading="lazy">
...
<img src="/images/20250512b/image_9.png" alt="" width="884" height="505" loading="lazy">

パイプラインで設定した変数やデータは、データフロー内で使えません。使いたい場合は、データフローのパラメーターに渡す必要があります。具体例を説明します。

まず、データフロー側でパラメーターを設定します。

<img src="/images/20250512b/image_10.png" alt="" width="764" height="197" loading="lazy">

次に、パイプライン側からデータフローのパラメーターに変数を設定します。

<img src="/images/20250512b/image_11.png" alt="" width="882" height="408" loading="lazy">
...
<img src="/images/20250512b/image_12.png" alt="" width="1200" height="1017" loading="lazy">
...
<img src="/images/20250512b/image_13.png" alt="" width="1200" height="564" loading="lazy">

ディレクトリにファイルを追加すると、設定したしたトリガーによってパイプラインが実行されていることがわかります。

<img src="/images/20250512b/image_14.png" alt="" width="1199" height="289" loading="lazy">
...
<img src="/images/20250512b/image_15.png" alt="" width="1200" height="424" loading="lazy">
...
<img src="/images/20250512b/image_16.png" alt="" width="1200" height="521" loading="lazy">

AI Searchインデックスに登録するパイプラインは以下のようになります。

<img src="/images/20250512b/image_17.png" alt="" width="1061" height="359" loading="lazy">
...
<img src="/images/20250512b/image_18.png" alt="" width="1200" height="365" loading="lazy">
...
<img src="/images/20250512b/image_19.png" alt="" width="805" height="484" loading="lazy">
...
<img src="/images/20250512b/image_20.png" alt="" width="1200" height="492" loading="lazy">
