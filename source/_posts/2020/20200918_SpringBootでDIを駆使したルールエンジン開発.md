...
<img src="/images/2020/20200918/技術ブログ素材2.png" width="1200" height="912" loading="lazy">
...
<img src="/images/2020/20200918/overview.png" width="922" height="495" loading="lazy">
...
メイン処理グループは１つの条件に対して１つ、サブ処理グループは複数定義でき、サブ処理グループには追加で判定条件を指定できます。メイン処理グループは基本的に同期で、サブ処理グループは非同期で実行されます。メイン処理グループも非同期に設定できます。

<img src="/images/2020/20200918/procgroup.png" width="848" height="473" loading="lazy">
...
<img src="/images/2020/20200918/architecture.png" width="922" height="495" loading="lazy">
...
余談ですが、標準でAWS Lambda実行のルールエンジン個別処理も用意されており、簡易な処理であればそちらも利用できます。
