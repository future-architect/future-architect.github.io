...
<img src="/images/2020/20200409/1.png" style="border:solid 1px #000000" width="1054" height="592" loading="lazy">
...
短期間・高品質での構築を実現するためにSwaggerを設計ドキュメントとしてだけではなく、コード自動生成やモックサーバーに活用させることで徹底したスキーマファーストな開発をしてきました。
