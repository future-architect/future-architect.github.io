...
categories:
  - Programming
series: "Zuora"
thumbnail: /images/2020/20200708/thumbnail.png
author: 多賀聡一朗
...
* [Zuora連載1：Zuora Central Platform概要](/articles/20200706/)
...
<img src="/images/2020/20200708/photo_20200708_01.jpeg" width="2500" height="2144">
...
<img src="/images/2020/20200708/1.png" class="bordered" width="1390" height="1336" loading="lazy">
...
1. **クレデンシャルを発行**: Zuora Central Platform 管理ページよりクレデンシャルを作成します。
   * 1.1. メニューより、「管理者」を選択
   <img src="/images/2020/20200708/2.png" class="img-small-size bordered" width="456" height="808" loading="lazy"><br>
   * 1.2. 「ユーザーの管理」を選択
   <img src="/images/2020/20200708/3.png" class="bordered" width="2472" height="986" loading="lazy">
   * 1.3. 「OAuth クライアント」から新規クライアントを作成し、 `client_id` と `client_secret` を保存します。
   <img src="/images/2020/20200708/4.png" width="2004" height="634" loading="lazy">
2. OAuth API をリクエストして Bearer トークンを取得
   ...
   * Type を 「OAuth 2.0」へ設定し、「Get New Access Token」を押下します。
   <img src="/images/2020/20200708/Get_New_Access_Token.png" width="2324" height="1060" loading="lazy">
   ...
   * <img src="/images/2020/20200708/request_token.png" width="1308" height="958" loading="lazy">
   * 2.3. アクセストークンが作成されます。
   <img src="/images/2020/20200708/access_token.png" width="1690" height="896" loading="lazy">
3. Bearer トークンを Authorization ヘッダーに付与してリクエスト
   ...
   * 3.1. 先ほど作成したトークンを指定します。
   <img src="/images/2020/20200708/select_token.png" width="2340" height="782" loading="lazy">
   * 3.2. URL とサンプルの Body をセットし、リクエストを実行します。
   <img src="/images/2020/20200708/sample_request.png" width="2334" height="1120" loading="lazy">
   * 3.3. 以下のように返却されると成功です。
   <img src="/images/2020/20200708/response_success.png" width="2348" height="554" loading="lazy">
...
```go ./zuoraClient/models/g_e_t_subscription_type.go
...
```go zuoraClient/models/g_e_t_subscription_rate_plan_charges_type.go
