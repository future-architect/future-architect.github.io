...
- <img src="/images/2020/20200131/1.png" class="img-middle-size" style="border:solid 1px #000000" width="1284" height="328" loading="lazy">
...
1. `○` を Click
   - <img src="/images/2020/20200131/2.png" class="img-middle-size" style="border:solid 1px #000000" width="2298" height="1018" loading="lazy">
2. Clear を指定
   - <img src="/images/2020/20200131/3.png" class="img-middle-size" style="border:solid 1px #000000" width="1206" height="432" loading="lazy">
3. Clear する Task の一覧が表示され OK を 指定する
   - <img src="/images/2020/20200131/4.png" class="img-middle-size" style="border:solid 1px #000000" width="1302" height="624" loading="lazy">
4. Clear (=リトライ) される
   - <img src="/images/2020/20200131/5.png" class="img-middle-size" style="border:solid 1px #000000" width="2232" height="1010" loading="lazy">
...
<img src="/images/2020/20200131/6.png" class="img-middle-size" width="1550" height="1372" loading="lazy">

こちらが発生した際は、他の手段を利用して、Clear できます。

1. `Browse > Task Instances` を指定
   - <img src="/images/2020/20200131/7.png" class="img-middle-size"  width="1384" height="560" loading="lazy">
2. 対象 Task を検索
   - <img src="/images/2020/20200131/8.png" class="img-middle-size"  width="1422" height="852" loading="lazy">
3. 対象 Task を指定して Clear
   - <img src="/images/2020/20200131/9.png" class="img-middle-size"  width="1422" height="806" loading="lazy">
4. Clear 完了
...
<a href="https://airflow.apache.org/docs/stable/timezone.html#time-zones"><img src="/images/2020/20200131/10.png" width="860" height="140" loading="lazy" class="img-small-size" style="border:solid 1px #000000"></a>
...
Web UI 上の、 `Trigger DAG` より手動での実行は可能ですが、任意のパラメータを指定して実行できません。
