...
2020年はServerlessアーキテクチャが当たり前のように採用される時代になってきていると実感します。フロントエンドからアクセスされるBackendのAPIはAWS環境だと、AppsyncやAPI Gateway+Lambaを利用し、IoTなどイベントドリブンなメッセージに対してはAWS IoTを使います。その後続はKinesisを使い、さらにその後続でLambdaやKinesis AnalyticsでETL処理を行い、データストアとしてDynamoDBやS3に格納するといった一連の流れになります。この流れ全てをフルマネージドなサービスに寄せて構築することも当たり前ですし、そういった事例も珍しく無くなってきました。
...
個人的にはジュニアなエンジニアがチームに多いのと、AWSに慣れていない新規参画者が多いという事情があります。「**他アプリがLambdaで完結している場合に、ECSという別のアプリランタイムを入れたくない**」という技術スタックをなるべく増やしたくないという思いがあり、できる限りアプリ開発はLambdaでやりたいと思ってます（Dockerfileもなるべく書かせなく無ければ、ECRやECSなどインフラ管理対象も増やしたくないし、CI/CDのバリエーションも下げて楽したいというのがあります）。
...
<img src="/images/2020/20200515/photo_20200515_01.png" width="972" height="764" loading="lazy">
...
<img src="/images/2020/20200515/photo_20200515_02.png" width="537" height="569" loading="lazy">
...
<img src="/images/2020/20200515/photo_20200515_03.png" width="2729" height="1319" loading="lazy">
...
<img src="/images/2020/20200515/photo_20200515_04.png" width="1082" height="527" loading="lazy">
...
<img src="/images/2020/20200515/photo_20200515_05.png" width="825" height="663" loading="lazy">
...
<img src="/images/2020/20200515/photo_20200515_06.png" width="1104" height="101" loading="lazy">
