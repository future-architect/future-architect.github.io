...
author: 伊藤真彦
lede: "夏休みの自由研究として、GoPlusを調査しました。この記事ではGoPlusを紹介し、簡単な内部構造を調査します。"
---
フューチャー[夏休みの自由研究](/articles/20200726/)連載の2回目です。

TIG DXユニットの伊藤真彦です。

夏休みの自由研究として、GoPlusを調査しました。

この記事ではGoPlusを紹介し、簡単な内部構造を調査します。
...
<img src="/images/2020/20200804/gop.jpg" class="img-middle-size" width="537" height="677" loading="lazy">
...
<img src="/images/2020/20200804/run.jpg" class="img-middle-size" width="235" height="39" loading="lazy">
...
<img src="/images/2020/20200804/qrun.jpg" class="img-middle-size" width="531" height="162" loading="lazy">
...
<img src="/images/2020/20200804/project.png" width="930" height="465" loading="lazy">
...
おめでとうGoPlus。
<img src="/images/2020/20200804/gop.png" width="1229" height="567" loading="lazy">

私は偉いので記事公開の1か月前に概ね書き終わっていたのですが、その間にもGoPlusは大きく進化していました。
追記執筆時点での最新の実装(v0.7.4)ではREPL(対話型インタプリタ)の実行機能が追加されたようです。

<img src="/images/2020/20200804/repl.png" width="547" height="180" loading="lazy">

さらには[vscode用プラグイン](https://github.com/goplus/vscode-goplus)の開発もスタートしました。
<img src="/images/2020/20200804/vscode.png" width="834" height="387" loading="lazy">
