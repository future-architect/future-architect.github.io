---
title: "Zuora連載1：Zuora Central Platform概要"
...
* Zuora連載1：Zuora Central Platform概要（この記事です）
* [Zuora連載2：Zuora REST API 利用と開発環境構築](/articles/20200708/)
* [Zuora連載3：Notification及びEventTriggerの話](/articles/20200716/)
* [Zuora連載4：Workflowの話](/articles/20200720/)
...
<img src="/images/2020/20200706/zuora_erd.png" width="2828" height="2454" loading="lazy">
...
<img src="/images/2020/20200706/product.png" class="img-small-size" width="646" height="838" loading="lazy">

### 顧客（Account）

顧客(Account)は複数の契約（subscription）を持つことができます。顧客(Account)は複数の請求方法（Payment method）を管理できます。請求（invoice）は顧客(Account)に紐づきます。

<img src="/images/2020/20200706/account.png" width="2074" height="922" loading="lazy">

### 契約(Subscription)

契約(Subscription)は商品(Product)が持つプラン(Product Rate Plan)をコピーして作られます。したがって、商品(Product)を変更しても契約済みのサブスクリプションは影響を受けません。

<img src="/images/2020/20200706/subscription.png" width="2460" height="1208" loading="lazy">
...
<img src="/images/2020/20200706/photo_20200706_01.png" width="3136" height="3353" loading="lazy">
...
* 顧客情報をZuoraに持つ必要がある
* 請求・消込まで行う場合、Zuoraでこれらを管理する必要があり
...
<img src="/images/2020/20200706/photo_20200706_02.png" width="561" height="361" loading="lazy">
