...
---
<img src="/images/2024/20240315a/image.png" alt="" width="1088" height="542">
...
また、各ディレクトリでbackendを持ち、tfstateを管理する形となるため`terraform`コマンドは各ディレクトリに対して行う必要があります。
...
ちょっとした亜種ですが、Workspace名をそのまま変数として持ってきてリソースに適用もできます。
