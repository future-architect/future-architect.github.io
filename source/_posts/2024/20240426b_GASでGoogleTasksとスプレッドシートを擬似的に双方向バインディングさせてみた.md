...
これを踏まえると、先ほどのA1セルをA2セルにコピー&ペーストするような使い方ではなく、「Viewにあたる表示部分のデータと、Modelにあたる何らかの処理機能を持つ部分のデータを自動的に連動させる仕組み」を作ってみました。すると、擬似的に双方向バインディングができているだけでなく、MVVMパターンのメリットも享受できていると言えそうです。
