...
categories:
  - Frontend
thumbnail: /images/2024/20240405a/thumbnail.png
author: 太田寛明
lede: "Vueのバージョンアップを行って得た、所感や躓いたポイントを共有します。"
---

<img src="/images/2024/20240405a/top.png" alt="" width="800" height="487">
...
今回の対応では、[対応内容](#対応内容)で紹介する「1. Vue3での動作に必要な変更」をまず最優先で対応し、その後により良いプロダクトとするための取り組みとして「2. Vue3からの新規推奨事項の適用」に対応しました。
