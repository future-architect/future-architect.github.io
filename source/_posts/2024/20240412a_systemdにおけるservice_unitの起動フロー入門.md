...
---
<img src="/images/2024/20240412a/IMG_8598.jpg" alt="" width="1200" height="831">
...
`service unit` とは `systemd` の設定単位の1つで、Linuxにおけるサービスの振る舞いを定義する設定をまとめたものです。主にデーモンやその他のシステムプロセスといった、起動や停止を含む管理をします。
