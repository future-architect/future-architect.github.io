...
categories:
  - DataScience
thumbnail: /images/2017/20171006/thumbnail_20171006.jpeg
author: 萩原元気
...
<img src="/images/2017/20171006/photo_20171006_01.jpeg" class="img-small-size" width="400" height="400" loading="lazy">
...
<img src="/images/2017/20171006/photo_20171006_02.png" width="1105" height="1031" loading="lazy">

さらに、カテゴリが自動設定されたことに驚かないよう、振り分けた旨のコメントもセットで投稿するようにしました。

<img src="/images/2017/20171006/photo_20171006_03.png" class="img-middle-size" width="1204" height="834" loading="lazy">
...
4. Kerasでチケットのカテゴリを判定する
5. カテゴリの判定結果をRedmineのWeb API経由でチケットを更新
6. カテゴリに紐付いたヘルプデスク担当者に、Redmine経由で通知がなされる

<img src="/images/2017/20171006/photo_20171006_04.png" width="1618" height="992" loading="lazy">
...
<img src="/images/2017/20171006/photo_20171006_05.png" width="1618" height="1012" loading="lazy">
...
<img src="/images/2017/20171006/photo_20171006_06.png" width="981" height="637" loading="lazy">
...
CNN、RNN、LSTMで技術検証した結果、最も正解率が高かったCNNを採用しました。
...
<img src="/images/2017/20171006/photo_20171006_07.png" width="1618" height="992" loading="lazy">
...
<img src="/images/2017/20171006/photo_20171006_08.png" width="1618" height="992" loading="lazy">
...
フューチャーアーキテクトでは、技術的視点だけでなく、ビジネス視点からも応用先を考え技術検証・現場への導入をしています。
