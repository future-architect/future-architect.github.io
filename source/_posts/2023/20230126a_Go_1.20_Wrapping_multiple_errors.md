...
categories:
  - Programming
series: "Go1.20リリース"
thumbnail: /images/2023/20230126a/thumbnail.png
author: 川口翔大
lede: "Wrapping multiple errors についてお話します。エラーのラップが拡張されて、複数のエラーをラップしたマルチエラーを作成できるようになりました。"
---

<img src="/images/2023/20230126a/top.png" alt="" width="800" height="492">
...
今までは、 `errors.Is`, `errors.As` を使ってラップされたエラーを検査できました。
