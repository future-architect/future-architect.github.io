...
最終週は、インターン生の成果発表会があり2・3週目程は時間が取れませんでした。タスクとしては CI/CD 周りを触らせていただき、チーム開発で負担になる review の補助をするツールを導入したりしました。CI/CDは完全に触ったことが無く、知識も疎かったのでキャッチアップするだけでかなりの時間を要してしまいました。しかし、ここから得られる知識も個人開発では到底経験出来ない新しいものが多くてとても勉強になりました。
