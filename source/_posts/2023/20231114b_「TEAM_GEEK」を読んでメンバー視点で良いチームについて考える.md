...
- **エゴを捨てる**
わかりやすい例は、コードレビューの時に、指摘を建設的なものにするために自己主張を捨てること（技術の差を見せつけるようなマウントまがいのレビューはしない）です。逆に、指摘をもらう際には「自分は自分が書いたコードではない」と認識して、過剰に反応することなく、謙虚に受け入れることも挙げられます。個人ではなくチームとしてのミッションにフォーカスすることが必要とされています。
- **非同期のコミュニケーション**
