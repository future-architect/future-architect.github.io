...
<img src="/images/2023/20230302a/image.png" alt="" width="400" height="564">
...
Google Cloud は障害を事前検知しているため[^4]、検知した際にライブマイグレーションに影響がない場合は、上記のようなライブマイグレーションで障害対応をしていることがわかりました。
