...
<img src="/images/20250822a/top.jpg" alt="" width="700  " height="700">
...
2025.08現在、Python Shell ジョブでは、Pythonのバージョンにv3.6またはv3.9を利用することができます。
...
Python Shellの実行環境では、boto3などのライブラリがサポートされており、追加の設定なしに利用することができます。
