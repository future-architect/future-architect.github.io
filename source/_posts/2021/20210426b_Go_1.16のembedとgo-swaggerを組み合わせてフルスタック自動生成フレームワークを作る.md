...
<img src="/images/2021/20210426b/go_vue_logo.png" class="img-middle-size" width="600" height="272" loading="lazy">
...
<img src="/images/2021/20210426b/image.png" style="border:solid 1px #000000" width="631" height="193" loading="lazy">
...
<img src="/images/2021/20210426b/image_2.png" style="border:solid 1px #000000" width="1200" height="658" loading="lazy">
...
<img src="/images/2021/20210426b/image_3.png" alt="base.tsの設定箇所" width="958" height="189" loading="lazy">

このまま`npm run serve`でアプリケーションを起動すると、存在しないAPIにアクセスし、通信に失敗する状態になります。

<img src="/images/2021/20210426b/image_4.png" alt="Vueアプリ起動画面" style="border:solid 1px #000000" width="1088" height="438" loading="lazy">

<img src="/images/2021/20210426b/image_5.png" alt="ブラウザの開発者画面で通信エラーが発生している" width="1158" height="742" loading="lazy">
...
<img src="/images/2021/20210426b/image_6.png" alt="Vueアプリ起動画面" style="border:solid 1px #000000" width="984" height="528" loading="lazy">

無事にアプリケーションが起動し、バックエンドAPIからのレスポンスを表示できました。

<img src="/images/2021/20210426b/image_7.png" alt="開発者ツールで正常に起動している" width="1155" height="1066" loading="lazy">
