...
2021年4月入社の山田です、[アルゴリズムとデータ構造連載](/articles/20210628a/)の6日目です。
...
<img src="/images/2021/20210707a/image.png" alt="問題イメージ" width="661" height="508" loading="lazy">
...
<img src="/images/2021/20210707a/image_2.png" alt="家とコンビニの距離" width="429" height="253" loading="lazy">
...
monotone minima は $i$ を適切な順番で計算していくことによって、計算の必要な $j$ の範囲を絞っていき、効率的に計算するアルゴリズムです。
...
<img src="/images/2021/20210707a/image_3.png" alt="範囲が分割されていない初期状態" width="553" height="561" loading="lazy">
...
<img src="/images/2021/20210707a/image_4.png" alt="一段回分割した状態" width="555" height="596" loading="lazy">

分割されたそれぞれの範囲で $jm$ の計算が行われます。この時行われる2つの $j$ の全探索について、探索範囲の重複を無視するとやはり合計で $O(M)$ 時間の計算になっていることが分かります。
さらに分割して、

<img src="/images/2021/20210707a/image_5.png" alt="分割した範囲で計算" width="554" height="627" loading="lazy">
