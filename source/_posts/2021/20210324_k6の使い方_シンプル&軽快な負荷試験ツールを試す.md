...
負荷試験ツールの定番と言えば[Apache Jmeter](https://jmeter.apache.org/)があります。改めて確認してみたところ2021年をもって生誕20周年を記念する老舗プロダクトでした、おめでとうございます。祝った上で使わない、使うべきではない言葉なので修正してください記事になってしまいました...
