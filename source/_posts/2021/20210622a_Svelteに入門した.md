...
author: 太田洋介
lede: "今年のゴールデンウィーク（STAY HOME週間）に最近話題のSvelteに入門したので紹介を書きます。Svelteは主にブラウザ上で動作するユーザーインターフェースを作るフレームワークで、ReactやVue.jsの対抗馬的な存在です。"
---
...
[Svelte]は主にブラウザ上で動作するユーザーインターフェースを作るフレームワークで、[React]や[Vue.js]の対抗馬的な存在です。
...
<img src="/images/2021/20210622a/image.png" alt="REPLの表示" width="402" height="134" loading="lazy">
