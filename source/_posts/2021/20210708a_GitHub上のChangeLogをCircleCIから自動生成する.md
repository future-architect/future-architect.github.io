...
私が所属してるプロジェクトでは、サーバサイドにGoを使用している関係で、真っ先に [goreleaser](https://github.com/goreleaser/goreleaser)を採用することを考えましたが、バイナリ配布ではやりすぎ感（あくまでやりたかったことはChangeLogの生成）があり、かつ、あまり上手く制御できなかった背景があり採用しませんでした。
