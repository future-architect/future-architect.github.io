...
<img src="/images/2021/20210427c/top.png" width="709" height="381" loading="lazy">
...
当発表では、「APIドキュメントファースト」ととして考えた結果、go-swagger を利用しているというスタンスになっています。ドキュメントと実装の乖離を防ぐというところに重きを置いて選定し、実際に乖離しないメリットは享受できておりました。
