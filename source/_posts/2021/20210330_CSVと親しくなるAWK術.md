...
<img src="/images/2021/20210330/penguine-4120917_1280.jpg" alt="" title="SmartphoneCreations2021によるPixabayからの画像" width="1200" height="800">
...
`pattern { action }` といった形で、patternが条件、actionが加工処理や表示項目の選択を指定します。
