...
<img src="/images/2021/20210420b/commit_rebase_master.png" alt="Rebase動作イメージ" width="1049" height="472" loading="lazy">

### コミットをまとめる(Squash)

`git rebase -i` に相当
<img src="/images/2021/20210420b/commit_rebase_squash.png" alt="Squash動作イメージ" width="1200" height="415" loading="lazy">

### 別ブランチのコミットを持ってくる(Cherry-pick)

`git cherry-pick` に相当
<img src="/images/2021/20210420b/2021-03-26-16-34-37.png" alt="Cherry-pick動作イメージ" width="1200" height="526" loading="lazy">
...
<img src="/images/2021/20210420b/sourcetree_rebase_master.gif" alt="Sourcetree Rebase操作動画" width="640" height="376" loading="lazy">
...
<img src="/images/2021/20210420b/sourcetree_rebase_squash.gif" alt="Sourcetree Squash操作動画" width="640" height="349" loading="lazy">
...
<img src="/images/2021/20210420b/sourcetree_cherrypick.gif" alt="Sourcetree Cherry-pick操作動画" width="640" height="382" loading="lazy">
...
2. Git Graph画面を開く
<img src="/images/2021/20210420b/gitgraph_open.gif" alt="VS Code動作動画" width="640" height="582" loading="lazy">
...
4. featureブランチがmasterブランチから生えていることを確認
<img src="/images/2021/20210420b/gitgraph_rebase_master.gif" alt="VS Code動作動画" width="640" height="529" loading="lazy">
...
5. featureブランチに持ってきたコミットが追加されてることを確認
<img src="/images/2021/20210420b/gitgraph_cherrypick.gif" alt="VS Code動作動画" width="640" height="545" loading="lazy">
...
<img src="/images/2021/20210420b/intellij_open.gif" alt="IntelliJ IDEAのGitプラグインのインストール" width="640" height="458" loading="lazy">
...
<img src="/images/2021/20210420b/intellij_rebase_master.gif" alt="IntelliJの操作動画" width="640" height="442" loading="lazy">
...
7. コミットがまとまったことを確認
<img src="/images/2021/20210420b/intellij_rebase_squash.gif" alt="IntelliJの操作動画" width="640" height="412" loading="lazy">
