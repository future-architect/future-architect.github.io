...
author: 市川燿
lede: "Go 1.17連載のラストです。この記事では、Go 1.17で変更になった sync/atomic パッケージについて解説します。sync/atomic パッケージの atomic.Value に以下のメソッドが追加されました。"
---

<img src="/images/2021/20210820a/cas.png" alt="" width="900" height="393">
