...
<img src="/images/2021/20210120/Androidのビルドの流れ.png" width="950" height="1068" loading="lazy">
...
<img src="/images/2021/20210120/Androidプロジェクトのディレクトリ構成.png" class="img-middle-size" width="660" height="904" loading="lazy">
...
**ビルドタイプ**は、本番用or開発用など、開発のライフサイクルに応じてバージョンを切り替えるために設定します。Android Studioで新規モジュールを作成する際は、releaseとdebugのビルドタイプが自動で作成されます。さらに独自のビルドタイプを設定して管理することもできます。ビルド時には最低1つのビルドタイプを指定する必要があります。
...
<img src="/images/2021/20210120/Screenshot_19700101-100351.png" class="img-small-size" width="1080" height="1920" loading="lazy">
...
<img src="/images/2021/20210120/①ビルドバリアントは2つ.png" width="842" height="268" loading="lazy">
...
<img src="/images/2021/20210120/mainのディレクトリ構成.png" class="img-middle-size" width="842" height="1046" loading="lazy">
...
<img src="/images/2021/20210120/debugのディレクトリ構成.png" class="img-middle-size" width="784" height="620" loading="lazy">
...
| <img src="/images/2021/20210120/debugでビルド.png" alt="debugでビルド" width="1080" height="1920" loading="lazy"> | <img src="/images/2021/20210120/releaseでビルド.png" alt="releaseでビルド" width="1080" height="1920" loading="lazy"> |
|---|---|
...
<img src="/images/2021/20210120/②ビルドバリアントは4つ.png" width="822" height="348" loading="lazy">
...
<img src="/images/2021/20210120/freeのディレクトリ構成.png" class="img-middle-size" width="822" height="1046" loading="lazy">
...
|<img src="/images/2021/20210120/freeDebugでビルド.png" alt="freeDebugでビルド" width="1080" height="1920" loading="lazy">|<img src="/images/2021/20210120/paidDebugでビルド.png" alt="paidDebugでビルド" width="1080" height="1920" loading="lazy"> | <img src="/images/2021/20210120/freeReleaseでビルド.png" alt="paidDebugでビルド" width="1080" height="1920" loading="lazy">| <img src="/images/2021/20210120/paidReleaseビルド.png" alt="paidReleaseビルド" width="1080" height="1920" loading="lazy">|
|---|---|---|---|
...
<img src="/images/2021/20210120/スクリーンショット_2021-01-16_21.04.12.png" width="822" height="630" loading="lazy">
...
<img src="/images/2021/20210120/freeDebugでビルド2.png" class="img-small-size" width="1080" height="1920" loading="lazy">
...
<img src="/images/2021/20210120/freeDebugのディレクトリ構成.png" width="822" height="734" loading="lazy">

そして改めてfreeDebugでビルドすると...
無事に「This is free!」と表示され、ビルドタイプに優先することが確認できました。

<img src="/images/2021/20210120/freeDebugでビルド3.png" class="img-small-size" width="1080" height="1920" loading="lazy">
...
<img src="/images/2021/20210120/③ビルドバリアント12通り.png" width="822" height="504" loading="lazy">
...
<img src="/images/2021/20210120/greenredのディレクトリ構成.png" class="img-middle-size" width="822" height="1254" loading="lazy">
...
|<img src="/images/2021/20210120/freeGreenDebugでビルド.png" alt="freeGreenDebugでビルド" width="1080" height="1920" loading="lazy"> | <img src="/images/2021/20210120/freeRedDebugでビルド.png" alt="freeRedDebugでビルド" width="1080" height="1920" loading="lazy"> | <img src="/images/2021/20210120/freePurpleDebugでビルド.png" width="1080" height="1920" loading="lazy"> |<img src="/images/2021/20210120/paidGreenDebugでビルド.png" alt="paidGreenDebugでビルド" width="1080" height="1920" loading="lazy"> |<img src="/images/2021/20210120/paidRedDebugでビルド.png" alt="freeRedDebugでビルド" width="1080" height="1920" loading="lazy"> | <img src="/images/2021/20210120/paidPurpleDebugでビルド.png" alt="paidPurpleDebugでビルド" width="1080" height="1920" loading="lazy">|
|---------------------|--------------------|----------------------|---------------------|-----------------|----------------------|
...
<img src="/images/2021/20210120/greenのディレクトリ構成2.png" width="822" height="688" loading="lazy">
...
<img src="/images/2021/20210120/Screenshot_19700101-115109.png" class="img-small-size" width="1080" height="1920" loading="lazy">
