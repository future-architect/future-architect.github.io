...
categories:
  - Programming
series: "Go1.17リリース"
thumbnail: /images/2021/20210819b/thumbnail.png
author: 宮崎将太
lede: "2021/8/16にGo1.17がリリースされましたね。Go 1.17連載第6回目ということで、Go Vetによる静的解析が強化され、errorを実装した構造体に対するIs/As/Unwrapのシグネチャチェックが実施されるようになったという小ネタを紹介します。"
---

<img src="/images/2021/20210819b/errors.png" alt="" width="900" height="304">
