...
category:
  - Programming
thumbnail: /images/20241011a/thumbnail.png
author: 王紹宇
...
<img src="/images/20241011a/1.png" alt="" width="1200" height="652" loading="lazy">

OSS のおかげで、言語のパックだけではなく、スニペット、配色テーマ、フォーマッター、テストツール、AI/ML、データサイエンスに関わるツールなど、多彩な拡張機能が満載ですね。

<img src="/images/20241011a/2.png" alt="" width="238" height="521" loading="lazy">
...
<img src="/images/20241011a/3.png" alt="" width="1200" height="237" loading="lazy">

<img src="/images/20241011a/4.png" alt="" width="1022" height="250" loading="lazy">

上記の挙動は、`package.json` に `contributes.commands` の記載と `src/extension.ts` の下記ロジックで実現されています。

<img src="/images/20241011a/5.png" alt="" width="1200" height="947" loading="lazy">
