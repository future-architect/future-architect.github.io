...
[future-architect/go-twowaysql](https://github.com/future-architect/go-twowaysql) についても、日々改善していてより使いやすくしていきたいと考えています。イベントの中で上がった、 `go:embed` 対応はぜひサポートできるようにしたいですね。
