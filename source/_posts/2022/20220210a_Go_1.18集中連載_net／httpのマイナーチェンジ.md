...
categories:
  - Programming
series: "Go1.18リリース"
thumbnail: /images/2022/20220210a/thumbnail.png
author: 真野隼記
lede: "Go 1.18のRelease Notesに記載があったMinor changes to the libraryにあったnet/httpの3点の更新について触れていきます。"
---
<img src="/images/2022/20220210a/image.png" alt="" width="1200" height="543" loading="lazy">
...
http.Clientを拡張する手段としてトランスポートがあります。例えば必ずエラーになるように拡張すると、HTTP GETが必ず失敗するはずです。
