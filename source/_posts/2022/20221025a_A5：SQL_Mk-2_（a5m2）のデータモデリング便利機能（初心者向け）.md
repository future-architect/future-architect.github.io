...
<img src="/images/2022/20221025a/共通列の設定.png" alt="共通列の設定" width="1200" height="616">
...
そのため、何かしらの修正が発生した場合にはGitHub上で差分を見てレビューできることは非常に良いです（もちろん `ddl.sql` を見てレビューでも良いと思いますが、本体側に予期せぬ変更が加えられていないか見られるのが良いです）。

<img src="/images/2022/20221025a/a5m2フォーマット.png" alt="" width="1200" height="1180" loading="lazy">
