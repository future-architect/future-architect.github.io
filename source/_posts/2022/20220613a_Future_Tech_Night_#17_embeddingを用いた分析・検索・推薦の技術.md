...
---
<img src="/images/2022/20220613a/top.png" alt="" width="660" height="263">
...
深層学習のモデルは画像や自然言語に対して高い精度の予測ができますが、その処理の過程で様々な意味を含んだベクトル(=embedding)を作ります。これを活用することで、どのデータとどのデータが意味的に似ているかを計算し分析できるようになります。
