...
はじめまして、TIGの原木です。[サービス間通信とIDL（インターフェース記述言語）連載](/articles/20220624a/)の4本目です。
...
* データベースのスキーマの変更に伴う影響をどうやって正確に見積もるか？
  * 例: 「データベースのテーブルのカラムを一部増やす対応をするって聞いたけど、そのテーブルを参照している他業務システムが結構あるんだよね。影響調査よろしくー」
...
しかし、この手法は主流となっておりません。なぜなら、そういった問題がそもそも生じる理由として境界付けられたコンテキストに従った適切なデータ分割をしていないことが考えられるからです。
...
<img src="/images/2022/20220629a/image.png" alt="" width="709" height="381" loading="lazy">
...
<img src="/images/2022/20220629a/Drawing_2022-06-26_16.50.55.excalidraw.png" alt="" width="369" height="338" loading="lazy">
...
<img src="/images/2022/20220629a/Drawing_2022-06-25_20.17.41.excalidraw.png" alt="" width="1200" height="740" loading="lazy">
