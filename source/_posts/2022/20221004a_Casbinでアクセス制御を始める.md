...
<img src="/images/2022/20221004a/casbin_image.png" alt="casbin_image.png" width="1200" height="531">
...
* https://casbin.io/docs/adapters に記載されている通り、複数のデータソースに対応しています。地味に`Ent`や`sqlx` といったO/Rマッパーも対応していて細かいです
  * `AutoSave` ですが、enforcerは `UpdatePolicy()` で動的に定義を変更できるため、それを自動で保存する機能です
