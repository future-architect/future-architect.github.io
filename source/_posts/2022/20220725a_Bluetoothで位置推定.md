...
[こちらの記事](https://qiita.com/shu223/items/7c4e87c47eca65724305)で詳しく紹介されていますが、`ビーコン自体が発するBluetoothの強度TxPower`と`RSSI`の値の関係から位置を計算できます。
...
<img src="/images/2022/20220725a/8094da77-f209-e092-608f-42bcd0f26b49.png" alt="" width="483" height="543">
...
簡潔に手法言うと、クラス分類モデルで位置を推定していきます。**但し、このやり方だと正確な距離は推定できません。**
...
また、タグを天井に配置できるためタグを隠す障害物の心配もなく、さらに飲食店の景観を損ねずに済みます。
