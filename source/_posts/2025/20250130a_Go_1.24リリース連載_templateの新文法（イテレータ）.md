...
author: 大江聖太郎
lede: "text/templateでのrange over func、range over intのサポート を取り上げます"
---
<img src="/images/2025/20250130a/go1.24.png" alt="" width="800" height="484">

## はじめに

TIG所属の大江です。[Go1.24リリース連載](/articles/20250127a/)の3本目です。
...
新たに導入されたrange over funcを使えば、直接テンプレート内で関数を呼び出し、戻り値を表示できます。
