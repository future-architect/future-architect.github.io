...
`iter` パッケージは1.23で新規に追加されたパッケージです。`iter` パッケージについては[1.23リリースでの当社解説記事](/articles/20240718a/)をご参照ください。
...
似たような解説を[1.22リリース時の当社記事](/articles/20240201a/)でも解説しているため、合わせてお読みください。
