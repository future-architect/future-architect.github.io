...
<img src="/images/2025/20250905a/作成したツール.png" alt="作成したツール" width="1010" height="835">
</a>
...
4. **テーマの切り替え**: Mermaid標準で用意されているテーマ（`default`, `forest`, `dark`, `neutral`, `base`, `base-dark`）を簡単に切り替えることができます。これにより、図の雰囲気を変更し、ドキュメントの雰囲気に合わせたり、視認性を高めたりできます。
