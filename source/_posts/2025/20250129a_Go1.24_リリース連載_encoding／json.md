...
categories:
  - Programming
series: "Go1.24リリース"
thumbnail: /images/2025/20250129a/thumbnail.png
author: 島ノ江励
lede: "Go 1.24 で encoding/json に追加される omitzero を扱います"
---

<img src="/images/2025/20250129a/go1.24.png" alt="" width="800" height="484">

## はじめに

こんにちは。ペンギンになりたいエンジニアの島ノ江です。普段は CSIG で「[FutureVuls](https://vuls.biz/lp/)」という脆弱性管理サービスの開発・営業を担当しています。

[Go1.24リリース連載](/articles/20250127a/)の2日目。Go 1.24 で encoding/json に追加される `omitzero` を扱います（[リリースノート](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)）
