...
<img src="/images/2025/20250522a/image.png" alt="" width="1200" height="675">
...
イギリスの Raspberry Pi 財団が開発した超小型のシングルボードコンピュータです。クレジットカードほどの大きさながら、Linux が動作し、通常のパソコンのように使えます。また Raspberry Pi には Model A や Zero、Pico など、サイズや性能によってモデル分けされており、用途に合わせて選定できます。
...
本番開発する前に、まずは必要なものを揃えてチュートリアル開発をクリアしましょう！
...
Raspberry Pi Pico W を使うためには、まず開発環境を整える必要があります。以下の手順で環境構築します。
