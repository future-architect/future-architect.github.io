...
---
<img src="/images/2025/20251002a/thumbnail.jpg" alt="" width="300" height="197">
...
* 継承が高コスト: 親スレッドのスレッドローカル変数を継承して子スレッドを作成できますが、全てのスレッドローカル変数に対する領域を割り当てる必要があるため多くのメモリが必要となる可能性があります。
