...
<img src="/images/2025/20250723a/斧を装備した戦士.png" alt="斧を装備した戦士" width="1024" height="1024">
...
素晴らしいことに ADKではOpenAPI仕様に準拠したJSONやYAMLファイルをインポートすることでツールを作成できます。
...
これでのようにして作成した`OpenAPIToolset`クラスのインスタンスがそのままツールとして利用できます。
...
このように1つ1つのAPIリクエストがツールとして構成されていることが分かります。
