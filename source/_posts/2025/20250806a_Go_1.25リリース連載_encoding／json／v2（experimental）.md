...
<img src="/images/2025/20250806a/top.jpg" alt="" width="1024" height="1024" loading="lazy">
...
`encoding/json/v2`の導入目的の1つは、性能向上にあります。特にUnmarshal（JSONからGoの構造体への変換）において顕著な速度差が見られるとのことなので検証してみました。
