...
|:--|:--|:--|:--|
| {% thumb %} | 6/30（火）| 柴田健太さん | Workspace Events API で GWS フォルダの変更をリアルタイム検知し、スプレッドシートを BigQuery に自動取り込みする（この記事です） |
| {% thumb 20260723a %} | 7/1（水）| 真野隼記さん | [データガバナンス設計ガイドラインを公開しました](/articles/20260723a/) |
| {% thumb 20260702a %} | 7/2（木）| 鈴木風真さん | [S3 TablesのIceberg形式で、timestamptz型の登録に苦戦した話](/articles/20260702a/) |
| {% thumb 20260703a %} | 7/3（金）| 棚井龍之介さん | [主要AIモデルのデータ保持期間とZDRを、一次情報で確認する](/articles/20260703a/) |
| {% thumb 20260706a %} | 7/6（月）| 片岡久人さん | [仕組みからわかる dbt Slim CI — GitHub Actions × Google Cloud Storage で実現する差分実行](/articles/20260706a/) |
