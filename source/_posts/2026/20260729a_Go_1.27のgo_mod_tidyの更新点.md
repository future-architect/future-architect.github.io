...
TIG真野です。[フューチャー技術ブログ Go 1.27 リリース連載](/articles/20260728a/)の2本目です。

Go 1.27で `go mod tidy` に追加された `require` ブロックの自動マージについて紹介します。[リリースノート上は数行のさらっとした変更](https://tip.golang.org/doc/go1.27#go-mod-tidy)ですが、裏側には2022年起票のIssueから約4年ごしの経緯があります。
