...
---
<img src="/images/2026/20260708a/image1.png" alt="" width="600" height="600">
...
前回のSecurityでも感じましたが、Specialtyの試験は、知っているかよりも、なぜそれを選ぶかを問うてきます。ネットワークではその傾向が特に強く、概要で挙げた要件を読み解いて、最適な1つを選ばせます。暗記だけでは届かず、選ぶ理由を言葉にできるかが問われました。
