...
category:
  - Infrastructure
author: 大貫武彦
lede: "クラウド環境におけるDWHの選択肢として、Redshiftはもはや珍しいものではなくなりましたが、当社内の採用実績はそれほど多くはありませんでした。
本記事は元々そのような社内向けに、Redshiftの基本的な仕様をなるべく網羅的に理解できるようまとめたものになります。"
---

クラウド環境におけるDWHの選択肢として、Redshiftはもはや珍しいものではなくなりましたが、当社内の採用実績はそれほど多くはありませんでした。
