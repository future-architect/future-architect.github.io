...
<img src="/images/2019/20190708/photo_20190708_01.png" width="822" height="88" loading="lazy">
...
自動作成されるGoogle管理サービスアカウントは文字通り自動で作成されているのであって、明示的にその存在を意識して作業することはあまり多くありません。
