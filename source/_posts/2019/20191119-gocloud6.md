...
<img src="/images/2019/20191119/go-cdk-logo-gopherblue.png" class="img-middle-size" width="900" height="489" loading="lazy">
...
GCPのリソースを管理するためのコマンドラインインターフェースとして [gcloud](https://cloud.google.com/sdk/gcloud/) があり、このgcloudコマンド経由で各種エミュレータを実行できます。
