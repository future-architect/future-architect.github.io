...
<img src="/images/2019/20190909/photo_20190909_01.png" style="border:solid 1px #000000" width="1832" height="492" loading="lazy">
...
また、`master`以外の特定ブランチのアプリケーションをデプロイしたい場合には`cloudshell_git_branch=<BRANCH_NAME>`を追加してあげると任意のブランチからデプロイできます。
...
<img src="/images/2019/20190909/photo_20190909_03.png" style="border:solid 1px #000000" width="1206" height="642" loading="lazy">

Cloud Shellの起動を確認するダイアログが出てくるので`続行`を押して次へ...

<img src="/images/2019/20190909/photo_20190909_04.png" style="border:solid 1px #000000" width="1818" height="480" loading="lazy">
...
<img src="/images/2019/20190909/photo_20190909_05.png" style="border:solid 1px #000000" width="1804" height="564" loading="lazy">
...
<img src="/images/2019/20190909/photo_20190909_06.png" style="border:solid 1px #000000" width="1820" height="596" loading="lazy">

コンテナのビルドが始まりました！ ...ワクワク

<img src="/images/2019/20190909/photo_20190909_07.png" style="border:solid 1px #000000" width="1914" height="938" loading="lazy">

ビルドが完了すると自動的にGCRへのイメージのpushも行ってくれます。そしてGCRのイメージをもとにCloud Runのデプロイがスタートします。こういったところを自動でやってくれるのがありがたいですね。

<img src="/images/2019/20190909/photo_20190909_08.png" style="border:solid 1px #000000" width="1838" height="1172" loading="lazy">

そして待つこと少々...ついにアプリケーションがデプロイされました。早速コンソールからデプロイされたアプリを確認してみましょう。

<img src="/images/2019/20190909/photo_20190909_09.png" style="border:solid 1px #000000" width="1904" height="478" loading="lazy">

いました。`cloud-run-hello`というアプリケーションが無事にデプロイされています！

<img src="/images/2019/20190909/photo_20190909_10.png" style="border:solid 1px #000000" width="2846" height="1082" loading="lazy">

詳細画面も覗いてみましょう。デプロイされたアプリケーションにアクセスしてみると...

<img src="/images/2019/20190909/photo_20190909_11.png" style="border:solid 1px #000000" width="1714" height="1100" loading="lazy">
